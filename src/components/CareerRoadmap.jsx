...
import { getInitialCareerRoadmap } from '../utils/mockData'
import { CareerRoadmapIcon } from '../icons/AllIcons'

const CareerRoadmap = () => {
  const [milestones, setMilestones] = useLocalStorage("careerRoadmap", getInitialCareerRoadmap())
  ...
  const handleReset = () => {
    setMilestones(getInitialCareerRoadmap())
  }
